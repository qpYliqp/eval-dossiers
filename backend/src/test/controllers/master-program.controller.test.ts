...
describe('Space Controller', () => {
    describe('POST /espace', () => {
        ...
        it('devrait renvoyer une erreur interne si une exception se produit lors de la création du programme master', async () => {
    ...
    describe('PUT /espace/:id', () => {
        ...
        it("devrait renvoyer une erreur si l'espace n'existe pas", async () => {
...
// import request from 'supertest';
// import express from 'express';
// import { createMasterProgram, deleteMasterProgram, getAllMasterPrograms, getMasterProgramById, updateMasterProgram } from '../../controllers/master-programs-controller';
// import { createMasterProgramService, deleteMasterProgramService, getAllMasterProgramsService, getMasterProgramByIdService, updateMasterProgramService } from '../../services/master-programs-service';
...
// app.get('/espace', getAllMasterPrograms);
// app.get('/espace/:id', getMasterProgramById);
// app.put("/:id", updateMasterProgram);


// describe('Space Controller', () => {
//   describe('POST /espace', () => {
//     it('devrait créer un espace dédié et retourner une réponse avec l\'espace créé', async () => {
//       const mockSpace = {
//         masterId: 1,
//         name: 'Espace A',
...
//   describe('DELETE /espace/:id', () => {
//     it('devrait supprimer un espace et retourner une réponse avec l\'espace supprimé', async () => {
//       const mockDeletedSpace = {
//         masterId: 1,
//         name: 'Espace A',
//         academicYear: '2025-2026',
...
//     it('devrait renvoyer une erreur si l\'espace n\'est pas trouvé', async () => {
//       (deleteMasterProgramService as jest.Mock).mockRejectedValueOnce(new Error('Espace non trouvé'));
...
// //Test si la récupértion de tous les espaces est fonctionnelle	
...
// //Test si la récupération d'un espace spécifique est fonctionnelle
// describe('GET /espace/:id', () => {
//   it('devrait récupérer un espace spécifique avec succès', async () => {
//     const mockSpace = {
//       masterId: 1,
//       name: 'Espace A',
//       academicYear: '2025-2026',
...
//   it('devrait renvoyer une erreur 404 si l\'espace n\'est pas trouvé', async () => {
//     (getMasterProgramByIdService as jest.Mock).mockRejectedValueOnce(new Error('Espace non trouvé'));
...
//     expect(response.status).toBe(404);
//     expect(response.body.message).toBe('Espace non trouvé');
//   });
...
//     expect(response.status).toBe(200);
//     expect(response.body.message).toBe('Espace mis à jour avec succès');
//     expect(response.body.updatedSpace).toEqual(mockEspace);
//   });

//   it("devrait renvoyer une erreur si l'espace n'existe pas", async () => {
//     (updateMasterProgramService as jest.Mock).mockRejectedValue(new Error("Espace non trouvé"));

//     const response = await request(app)
//       .put('/espace/99')
//       .send({
//         name: "Espace Inexistant",
//         academicYear: "2026-2027",
//         academicUnit: "UF Histoire",
//         updatedBy: "user"
//       })
